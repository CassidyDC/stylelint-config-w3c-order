...
export const inlineLayoutModule = {
  baselines: [
    ...
    'baseline-shift', // This property is going to be deprecated and authors are advised to use vertical-align instead. Ref: https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/baseline-shift
    'baseline-source',
