 ...
 * @see {@link https://drafts.csswg.org/css-anchor-position-1/#property-index W3C Editor's Draft}
 * @see {@link https://www.w3.org/TR/css-anchor-position-1/#property-index W3C Working Draft}
 */
export const anchorPositioningModule = {
  anchors: [
    'anchor-name',
    'anchor-scope', // not yet implemented in browsers
  ],
  positions: [
    'position-anchor',
    'position-area',
